...
<footer>
    <div class="wraper">
        <div class="avisos">
            <label class="fieldsForm ">Producto:</label>
            <br>
            <p>Nuestro gestor hostapp, nace para cubrir la necesidad de medianos o pequeñas pymes
                del sector de la hosteleria ofreciendo a los mismos una solución simple y eficáz
                para la gestión diaria de clientes, reservas, menus etc. 
            </p>
            <br>
        </div>
        <div class="avisos">
            <label class="fieldsForm ">Redes sociales:</label>
            <br>
        ...
        <div class="avisos">
            <label class="fieldsForm ">Ayuda:</label>
            <br>
        ...
        <div class="avisos">
            <label class="fieldsForm ">Aviso legal:</label>
            <br>
