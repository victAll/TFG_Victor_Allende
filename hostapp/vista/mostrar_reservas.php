                            ...
                            foreach ($dato as $key => $value) {
                                foreach ($value as $valor) : ?>
                                    <tr>
                                        ...
                                        <td><a class="btn" href="index.php/?opcion=editar_reserva&id=<?php echo $valor['id']; ?>" class="btn btn-primary">Editar</a></td>
                                        <td><a class="btn" href="index.php/?opcion=eliminar&id=<?php echo $valor['id']; ?>&tabla=reservas&redireccion=reserva" class="btn btn btn-primary">Eliminar</a></td>
